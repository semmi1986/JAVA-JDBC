...
public class UserDaoHibernateImpl implements UserDao {
    private static final String CREATE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS users " +
            "(id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, name VARCHAR, lastName VARCHAR, age SMALLINT CHECK (age>=0), email VARCHAR)";
    private static final String DROP_TABLE_SQL = "DROP TABLE IF EXISTS users";
//    private static final String CLEAN_USER_SQL = "DELETE FROM users";
//    private static final String SELECT_USER_SQL = "FROM User";
...
//            Transaction tx = session.beginTransaction();
//
//            users = session.createNativeQuery(SELECT_USER_SQL).list();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        return users;
